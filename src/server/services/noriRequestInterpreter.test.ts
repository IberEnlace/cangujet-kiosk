...
const interpretations: Array<[string, (value: ReturnType<typeof interpretNoriRequest>) => boolean]> = [
  ...
  ["I need food after the gym", value => value.constraints.wantsPostWorkoutMeal && value.constraints.priorities.includes("protein") && value.constraints.minProtein === null],
  ...
  ["I want something delicious and filling", value => value.constraints.wantsFillingMeal && !value.clarificationNeeded],
