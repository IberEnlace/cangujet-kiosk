...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      activate_device_key: { Args: { p_key_hash: string; p_installation_id: string; p_device_type: DeviceType; p_device_name?: string | null; p_app_version?: string | null; p_request_id?: string | null; p_metadata?: Json }; Returns: Array<{ device_id: string; activation_key_id: string; restaurant_id: string; branch_id: string; device_type: DeviceType; device_name: string; device_status: DeviceStatus; configuration_version: number; duplicate: boolean }> };
    };
    Enums: {
