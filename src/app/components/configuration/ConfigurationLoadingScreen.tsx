...
export default function ConfigurationLoadingScreen() {
  ...
  return <main className="grid min-h-[100dvh] place-items-center bg-[#080b08] p-6 font-['Plus_Jakarta_Sans'] text-white">
