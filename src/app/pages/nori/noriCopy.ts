...
export const noriCopy: Record<SupportedLanguage, NoriCopy> = {
  en: {
    ...
    privacy: "Your speech is processed only to understand this conversation. Audio is not stored by MORROW.",
  ...
  tr: {
    ...
    privacy: "Konuşmanız yalnızca bu görüşmeyi anlamak için işlenir. Ses MORROW tarafından saklanmaz.",
