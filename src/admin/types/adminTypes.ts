...
export interface AdminProduct { id: string; name: string; description: string; category: string; categoryId?: string; price: number; image: string; available: boolean; calories: number; protein: number; allergens: string[] }
export interface AdminCategory { id: string; name: string; description: string; image?: string; icon: string; displayOrder: number; active: boolean }
